...
const Sidebar = () => {
  const styles = {
    ...
    profile: ` w-full py-0 flex flex-col justify-center items-center rounded-r-3xl mt-[40px] mb-[40px] border-1 border-[#33ffff]`,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logo_h} alt='HS' height={150} width={150} />
      </div>
    </div>
  )
}
